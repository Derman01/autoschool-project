...
const SVG = () =>
	<svg width="124" height="41" viewBox="0 0 124 41" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<path
			...
			fill="#3649F4" fill-opacity="0.15"/>
		<path d="M87.4121 34.0759H35.9175V39.0769H87.4121V34.0759Z" fill="#3649F4" fill-opacity="0.15"/>
		<path
...
export const Card: FC<CardOptions> = (options) => {
	...
	const openModelCreateCar = useCallback(() => {
		PopupOpener.createModal({
			templateOptions: {
				bodyContent: <div>Окно создания карточки авто</div>,
		...
		<div className={classNames(['car__emptyCard', className])}>
			<div className="car__emptyCard_content">
				...
				<div className="car__emptyCard_footer">
					...
					<Button onClick={openModelCreateCar} icon={'plus'} viewMode={'icon'} iconSize={'m'}/>
				</div>
			</div>
		</div>
	);
